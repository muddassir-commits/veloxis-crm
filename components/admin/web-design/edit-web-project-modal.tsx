  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-lg bg-[#0D1829] border border-[#1E3352] text-[#F0F4FF] max-h-[90vh] overflow-y-auto select-none">
          <DialogHeader>
            <DialogTitle className="text-md font-bold text-[#F0F4FF]">Edit Web Project</DialogTitle>
          </DialogHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 py-2 text-xs">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <Label className="text-[#8BA3C7] text-[11px] font-medium">Project Stage</Label>
            ...
            <DialogFooter className="mt-4 pt-2 border-t border-[#1E3352]/30 flex justify-between items-center sm:justify-between w-full">
              <Button
                type="button"
                variant="ghost"
                onClick={() => setDeleteDialogOpen(true)}
                className="text-[#EF4444] hover:bg-red-500/10 hover:text-red-400 border border-red-500/20 bg-red-500/5 text-xs h-9 cursor-pointer animate-none"
              >
