  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-6 select-none">
        <div>
          <h3 className="text-sm font-semibold text-[#F0F4FF]">Organic Traffic — Last 6 Months</h3>
          <p className="text-[10px] text-[#4A6480] mt-0.5">GOOGLE SEARCH CONSOLE & ANALYTICS SESSIONS</p>
        </div>
