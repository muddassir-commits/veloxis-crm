  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-6 select-none">
        <div>
          <h3 className="text-sm font-semibold text-text-primary">Revenue — Last 6 Months</h3>
          <p className="text-[10px] text-text-tertiary mt-0.5">SUM OF ALL PAID INVOICES</p>
        </div>
